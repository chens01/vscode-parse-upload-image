...
exports.pasteUploadImage = void 0;
const clipboard_service_1 = __webpack_require__(3);
const git_service_1 = __webpack_require__(7);
const config_service_1 = __webpack_require__(47);
const vscode = __webpack_require__(1);
const fs = __webpack_require__(5);
async function pasteUploadImage() {
    const { token, owner, repo } = (0, config_service_1.getConfiguration)();
    git_service_1.default.init(token, owner, repo);
    ...
    const { imgPath, isTemp } = await (0, clipboard_service_1.getPathFromClipboard)();
    const filePath = fileUri.fsPath;
    const fileName = `${filePath.substr(filePath.lastIndexOf('/') + 1).replace('.md', '')}-${+new Date()}.png`;
    const imgUrl = await git_service_1.default.uploadImage(fileName, imgPath);
...
exports.pasteUploadImage = pasteUploadImage;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getPathFromClipboard = void 0;
const path = __webpack_require__(4);
const fs = __webpack_require__(5);
const child_process_1 = __webpack_require__(6);
function runMacScript(imgPath) {
    let scriptPath = path.resolve(__dirname, '../res/mac.applescript');
    console.log(__dirname);
    console.log('scriptPath', scriptPath);
    return new Promise((resolve, reject) => {
        let ascript = (0, child_process_1.spawn)('osascript', [scriptPath, imgPath]);
...
function runWindowScript(imgPath) {
...
async function getPathFromClipboard() {
...
exports.getPathFromClipboard = getPathFromClipboard;
...
const fs = __webpack_require__(5);
class Git {
    static init(token, owner, repo) {
        this.token = token.trim();
        this.owner = owner.trim();
        this.repo = repo.trim();
    }
    static doRequest(url, params) {
        url = `${this.host}/${this.owner}/${this.repo}${url}`;
        return axios_1.default.put(url, params, {
            headers: {
    ...
    static async uploadImage(fileName, imagePath) {
        ...
        const result = await this.doRequest(url, params);
        console.log('result', result);
        return result.content.download_url;
    }
}
Git.host = 'https://api.github.com/repos';
Git.token = '';
Git.owner = '';
Git.repo = '';
exports["default"] = Git;
...
const FormData$1 = __webpack_require__(9);
...
const followRedirects = __webpack_require__(32);
const zlib = __webpack_require__(44);
const stream = __webpack_require__(12);
const EventEmitter = __webpack_require__(45);
...
var CombinedStream = __webpack_require__(10);
...
var populate = __webpack_require__(30);
...
var util = __webpack_require__(11);
var Stream = (__webpack_require__(12).Stream);
var DelayedStream = __webpack_require__(13);
...
module.exports = __webpack_require__(37)(exports);
...
function setup(env) {
	...
	createDebug.humanize = __webpack_require__(38);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.scanUploadImage = void 0;
const git_service_1 = __webpack_require__(7);
const config_service_1 = __webpack_require__(47);
const vscode = __webpack_require__(1);
const path = __webpack_require__(4);
async function scanUploadImage() {
    const { token, owner, repo } = (0, config_service_1.getConfiguration)();
    git_service_1.default.init(token, owner, repo);
    const editor = vscode.window.activeTextEditor;
    ...
    vscode.window.withProgress({
        ...
        return new Promise(async (resolve) => {
            ...
            for (let i = 0; i < total; i++) {
                ...
                const fileName = `${filePath.substr(filePath.lastIndexOf('/') + 1).replace('.md', '')}-${+new Date()}.png`;
                const imgUrl = await git_service_1.default.uploadImage(fileName, imgFullPath);
                const renderFilePath = `![](${imgUrl})`;
                console.log('renderFilePath', renderFilePath);
                renderFilePaths[tag[0]] = renderFilePath;
            }
            editor.edit((edit) => {
                Object.keys(renderFilePaths).forEach((tag) => {
                    const renderFilePath = renderFilePaths[tag];
                    const start = text.indexOf(tag);
                    let fullRange = new vscode.Range(editor.document.positionAt(start), editor.document.positionAt(start + tag.length));
...
exports.scanUploadImage = scanUploadImage;
...
const vscode = __webpack_require__(1);
const paste_upload_image_1 = __webpack_require__(2);
const scan_upload_image_1 = __webpack_require__(46);
function activate(context) {
    let disposable = vscode.commands.registerCommand('extension.paste-upload-image', async () => {
        try {
            await (0, paste_upload_image_1.pasteUploadImage)();
        }
        catch (err) {
    ...
    let disposable2 = vscode.commands.registerCommand('extension.scan-upload-image', async () => {
        await (0, scan_upload_image_1.scanUploadImage)();
    });
